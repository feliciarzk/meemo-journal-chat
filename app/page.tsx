...
function ChatMock() {
  ...
  return (
    <div className="relative w-full max-w-sm rounded-[28px] border border-white/10 bg-[#1D1A2B] p-5 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.6)]">
...
export default function Home() {
  return (
    ...
    >
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center gap-16 px-6 py-16 lg:flex-row lg:items-center lg:gap-12">
        {/* left column */}
        <div className="flex flex-1 flex-col gap-6 lg:max-w-md">
          ...
          <div className="mt-2 flex gap-3">
            <Link
              href="/login"
              className="rounded-xl bg-[#7C74E8] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#8f87f2] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7C74E8]"
            >
              Masuk
            </Link>
            <Link
              href="/register"
              className="rounded-xl border border-white/15 px-6 py-3 text-sm font-semibold text-white/90 transition hover:bg-white/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/40"
            >
              Daftar
            </Link>
          </div>

          <div className="mt-6 flex flex-col gap-2.5 border-t border-white/10 pt-6 text-[13px] text-white/45">
