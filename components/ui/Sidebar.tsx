...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex h-screen w-72 flex-col border-r border-white/10 bg-gradient-to-b from-[#171321] via-[#15111F] to-[#13111C] transition-transform duration-300 md:relative md:z-auto md:translate-x-0 md:transition-all ${
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-6">
          ...
          <button
            onClick={onToggle}
            className="hidden rounded-xl p-2 transition hover:bg-white/10 md:flex"
          >
